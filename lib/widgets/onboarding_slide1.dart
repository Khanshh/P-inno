...
class OnboardingSlide1 extends StatefulWidget {
  ...
  const OnboardingSlide1({super.key, required this.onNext, this.onSkip});

  @override
  State<OnboardingSlide1> createState() => _OnboardingSlide1State();
}

class _OnboardingSlide1State extends State<OnboardingSlide1> with TickerProviderStateMixin {
      ...
      children: [
        ...
        _slideIn(
          ...
          child: Padding(
            ...
            child: Text(
              "Hành trình IVF của bạn bắt đầu ở đây.",
        ...
        _slideIn(delay: 0.3, child: _buildIndicator()),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          ...
          child: const Icon(Icons.spa_rounded, size: 55, color: Colors.white),
        ),
      ),
    );
  }
