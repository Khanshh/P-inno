...
class OnboardingSlide2 extends StatefulWidget {
  ...
  const OnboardingSlide2({super.key, required this.onNext, this.onSkip});

  @override
  State<OnboardingSlide2> createState() => _OnboardingSlide2State();
}

class _OnboardingSlide2State extends State<OnboardingSlide2> with TickerProviderStateMixin {
        ...
        return Stack(
          children: [
            Positioned(
              ...
              child: _buildOrb(400, const Color(0xFFE2F1AF).withValues(alpha: 0.4)),
            ),
            Positioned(
              bottom: -150 + (40 * _backgroundController.value),
              left: -120 + (30 * _backgroundController.value),
              child: _buildOrb(450, const Color(0xFFD1F1F1).withValues(alpha: 0.6)),
            ),
          ],
        );
      },
      ...
      children: [
        ...
        _slideIn(
          ...
          child: Padding(
            ...
            child: Text(
              "Công nghệ thông minh hỗ trợ các cặp đôi hiếm muộn.",
              textAlign: TextAlign.center,
              style: GoogleFonts.plusJakartaSans(
    ...
    return Container(
      ...
      child: Center(
        child: Container(
          ...
          child: const Icon(Icons.monitor_heart_rounded, size: 55, color: Colors.white),
        ),
      ),
    );
  }
