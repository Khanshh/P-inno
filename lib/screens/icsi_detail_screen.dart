...
class _ICSIDetailScreenState extends State<ICSIDetailScreen> with TickerProviderStateMixin {
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return Stack(
          children: [
            Positioned(
              top: 150 + (40 * _backgroundController.value),
              right: -50 + (10 * _backgroundController.value),
              child: _buildOrb(420, const Color(0xFFD1F1D1).withOpacity(0.4)),
            ),
            Positioned(
              bottom: 150 + (30 * _backgroundController.value),
              left: -100 + (25 * _backgroundController.value),
      ...
      children: [
        _buildGlassCard(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildSectionTitle(Icons.biotech_rounded, 'Chi tiết phương pháp'),
        ...
        _buildSectionCard('Ưu điểm', [
          ...
          'Dùng được tinh trùng tinh hoàn',
        ...
        _buildSectionCard('Lưu ý', [
          ...
          'Cần chuyên viên tay nghề cao',
          'Nguy cơ tổn thương trứng (rất thấp)',
  ...
  Widget _buildTimeline() {
    final List<Map<String, dynamic>> steps = [
      ...
      {'id': '2', 'title': 'Lấy trứng', 'duration': '15-20 phút', 'desc': 'Chọc hút trứng qua ngả âm đạo dưới hướng dẫn siêu âm.'},
      {'id': '3', 'title': 'Lấy tinh trùng', 'duration': 'Cùng ngày', 'desc': 'Lấy và lọc rửa mẫu tinh trùng tốt nhất.'},
      {'id': '4', 'title': 'Tiêm tinh trùng (ICSI)', 'duration': '1 ngày', 'desc': 'Tiêm trực tiếp 1 tinh binh vào bào tương của noãn.'},
      ...
      {'id': '7', 'title': 'Xét nghiệm thai', 'duration': '14 ngày sau', 'desc': 'Xét nghiệm máu kiểm tra kết quả thụ thai.'},
    ];
  ...
  Widget _buildVideoCard() {
    return Container(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 10),
        Text('Quy trình ICSI chuẩn quốc tế', style: GoogleFonts.plusJakartaSans(fontSize: 15, color: Colors.white.withOpacity(0.9), fontWeight: FontWeight.w600)),
